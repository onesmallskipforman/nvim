" global settings
if !exists('g:syntax_on') | syntax enable | endif " enable syntax one (NT devicons)
...
autocmd BufNewFile,BufRead aptfile  set syntax=zsh   " use zsh hl for aptfile
autocmd BufNewFile,BufRead skhdrc   set syntax=zsh   " use zsh hl for skhdrc
autocmd BufNewFile,BufRead lfrc     set syntax=zsh   " use zsh hl for lfrc
